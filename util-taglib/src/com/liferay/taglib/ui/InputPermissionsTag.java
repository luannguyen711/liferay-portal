...
public class InputPermissionsTag extends IncludeTag {
	...
	public static String doTag(
			String formName, String modelName, boolean documentMedia,
			PageContext pageContext)
		throws Exception {

		return doTag(
			_PAGE, formName, modelName, false, documentMedia, pageContext);
	}

	public static String doTag(
			String page, String formName, String modelName, boolean reverse,
			boolean documentMedia, PageContext pageContext)
		throws Exception {
	...
	public int doEndTag() throws JspException {
		try {
			doTag(
				getPage(), _formName, _modelName, _reverse, _documentMedia,
				pageContext);
